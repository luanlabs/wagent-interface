const Metadata = () => {
  return (
    <>
      ...
      <meta
        name="description"
        content="Wagent: Your Advanced Payment Gateway Solution for Stellar and Soroban. Simplify your online transactions with our powerful features tailored for both merchants and buyers."
      />
